          ...
          <table id="dataTableExample" class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn bg-success rounded-pill text-white w-75 @if($idea->status->name != 'Open') bg-red @endif ">
                ...
                <tr>
                    ...
                    <td>{{ $idea->spams()->count() }}</td>
                    <td><button class="btn bg-success rounded-pill text-white w-75 @if($idea->status->name != 'Open') bg-red @endif ">
                        @if($idea->status->name == 'Open')
                             აქტიური
                        @else
                             დასრულებული
