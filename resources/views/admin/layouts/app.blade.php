	...
	<div class="main-wrapper">
      ...
      <div class="sidebar-body">
        <ul class="nav" id="sidebarNav">
          ...
          <li class="nav-item items-addactive">
            <a href="{{ route('admin_dashboard') }}" class="nav-link" data-toggle="tab"]>
              <i class="link-icon" ></i>
          ...
          <li class="nav-item items-addactive">
            <a href="{{ route('admin_polls') }}" class="nav-link" data-toggle="tab"]>
              <i class="link-icon" ></i>
		...
		<div class="page-wrapper">
          ...
          <div class="container-fluid">
            <div class="container-fluid position-relative">
              ...
              <a href="{{ route('admin_search') }}" class="refresh-btn"><i class="bi bi-arrow-clockwise"></i></a>
              <form action="{{ route('admin_search') }}" method="get" class="row mt-2 gx-2">
                  <div class="col-4">
                    <div class="input-group">
                      <input type="text" name="search" class="form-control  admin-search-inp" id="geo_inp" placeholder="Search anything...">  
                  ...
                  <div class="col-4 ">
                    <select class="form-select me-1 cursor-pointer admin-select-inp" name="top" aria-label="Default select example">
                      <option value="id">Select By</option>
                      <option value="spams">Spams</option>
                  ...
                  <div class="col">
                    <div class="form-check d-flex justify-content-around pt-2">
                      <div class="form-check">
                        <input class="form-check-input typeofcheckbox cursor-pointer" type="checkbox" name="type" value="1"   id="flexCheckDefault">
                        <label class="form-check-label" for="flexCheckDefault">
                         Type-1
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input typeofcheckbox cursor-pointer" type="checkbox" name="type" value="2" id="flexCheckDefault">
                        <label class="form-check-label" for="flexCheckDefault">
                          Type-2
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input cursor-pointer statuscheckbox" type="checkbox" name="statusCheck" value="Open"id="flexCheckDefault">
                        <label class="form-check-label" for="flexCheckDefault">
                          Status Open
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input cursor-pointer statuscheckbox" type="checkbox" name="statusCheck" value="Closed" id="flexCheckDefault">
                        <label class="form-check-label" for="flexCheckDefault">
                          Status Closed
                        </label>
                      </div>
