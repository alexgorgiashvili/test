...
<x-app-layout>
    ...
    <div class="container-fluid position-relative px-0 pt-md-3 pt-1">
        ...
        <div class="col position-absolute w-100 pollone">
            <form action="{{ route('update_one', $idea->id) }}" class="add-form " method="post" enctype="multipart/form-data">
                @csrf
                @method('patch')
                <div class="mb-3">
        ...
        <div class="col position-absolute w-100 ">
            <form  class="add-form "action="{{ route('update_two',$idea->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('patch')
